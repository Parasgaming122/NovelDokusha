...
class MTLNovel(
    ...
    // Domain moved from www.mtlnovel.com to mtlnovels.com (the old domain times out).
    // The site structure is identical, including the WordPress ajax search endpoint.
    // Site is behind Cloudflare's JS challenge — handled at runtime by
    // CloudFareVerificationInterceptor (which now also detects 200-with-body-challenge).
    override val baseUrl = "https://mtlnovels.com/"
    override val catalogUrl = "https://mtlnovels.com/alltime-rank/"
    ...
    override suspend fun getCatalogSearch(
        ...
        tryConnect {
            ...
            val url = """https://mtlnovels.com/wp-admin/admin-ajax.php"""
                .toUrlBuilderSafe()
                .add("action", "autosuggest")
                .add("q", input)
                .add("__amp_source_origin", "https://mtlnovels.com")
                .toString()
