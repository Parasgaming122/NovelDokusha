 ...
 *
 * NOTE: Domain changed from .meme to .org (the .meme domain expired and is
 * no longer reachable). The HTML structure is unchanged.
 */
class ReadLightNovel(
    ...
    override val catalogUrl = "https://www.readlightnovel.org/top-novels/new/1"
