...
class NovelBin(private val networkClient: NetworkClient) : SourceInterface.Catalog {
    ...
    // Domain changed from .me to .net (the .me domain expired; .net is the
    // same WordPress site with identical HTML structure and selectors).
    override val baseUrl = "https://novelbin.net/"
    override val catalogUrl = "https://novelbin.net/sort/novelbin-daily-update"
    override val iconUrl = "https://novelbin.net/img/logo.png"
